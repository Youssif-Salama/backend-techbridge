...
import { filterQueryUponRelationByIdMiddleware, paginationFeatureMiddleware, searchMiddleware, sortingFeatureMiddlware } from "../../middlewares/features.middlewares.js";
import userModel from "../models/user.model.js";
import { executionMiddleware } from "../../middlewares/common.middlewares.js";
import { addASkill, changeImage, deleteASkill, updateMyData } from "../controllers/user.controllers.js";
...
const usersSearchKeys=["Fname","Lname","Email","Phone","Address.country","Address.city","Address.state","Address.street","Address.zipCode","Address.countryCode","skills","Languages","Experience"];
...
userRouter.put("/change-image",authentication,changeImage);
...
userRouter.get("/job-applied",authentication,getQueryMiddleware(applicationModel),myAppliedJobs,executionMiddleware({
  success:{
    message:"applications fetched successfully",
    statusCode:200
  },
